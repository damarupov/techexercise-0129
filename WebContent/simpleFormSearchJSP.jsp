...
<body>
	...
	<%!String runMySQL() throws SQLException {
		...
		try {
			connection = DriverManager.getConnection("jdbc:mysql://ec2-18-223-152-203.us-east-2.compute.amazonaws.com:3306/myDB", "newMysqlRemoteuser", "mypassword");
		...
		try {
			...
			String qSql = "SELECT * FROM myTable where myuser = ?";
